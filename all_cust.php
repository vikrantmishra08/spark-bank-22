...
<body style="background-color:#090924;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="images/logo.png" alt=""
                    style="height: 40px; margin-left:10px; margin-top:8px;"></a>
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:#fe4f6c; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
