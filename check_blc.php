							...
							<div class="single-slide-item-tablecell">
								...
								<center>
									...
									<div
										...
										<h1 style=" color:white; font-size:26px">Check Account Balance</h1>
									</div>
									...
									<div class="container"
										...
										<form action="check_blc.php" method="post">
											...
											<p style="color:white;">Don't remember your account number? check <a href="all_cust.php" style="color: #fe4f6c;">here</a>
											</p>
										</form>
									</div>
